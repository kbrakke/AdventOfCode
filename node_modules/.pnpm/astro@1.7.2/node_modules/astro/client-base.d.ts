...
type MD = import('.pnpm/astro@1.7.2/node_modules/astro').MarkdownInstance<Record<string, any>>;
...
declare module '*.mdx' {
	type MDX = import('.pnpm/astro@1.7.2/node_modules/astro').MDXInstance<Record<string, any>>;
